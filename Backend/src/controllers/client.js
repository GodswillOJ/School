...
export const fetchOrders = async (req, res) => {
  try {
    ...
    const orders = await Order.find({ userID }).select('orderDetails.items.productId dateOrdered status orderDetails shippingAddress1 shippingAddress2 city zip country phone');
